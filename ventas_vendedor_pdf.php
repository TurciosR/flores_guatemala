...
class PDF extends FPDF
{
    ...
    public function Header()
    {
        ...
        $this->MultiCell(
            140,
            5,
            utf8_decode(Mayu(utf8_decode('Sucursal ' . ': ' . $this->c))),
            0,
            'C',
            0
        );
        ...
        $this->Cell(
            195,
            6,
            utf8_decode('REPORTE DE VENTAS POR VENDEDOR'),
            0,
            1,
            'C'
        );
    ...
    public function Footer()
    {
        ...
        $this->Cell(
            40,
            10,
            utf8_decode('Fecha de impresión: ' . date('Y-m-d')),
            0,
            0,
            'L'
        );
