...
function initial()
{
    ...
    if (isset($_REQUEST['id_pedido'])) {
        ...
        $sql_pedido = _query(
            "SELECT co.*, cl.nombre 
            FROM pedido AS co, cliente 
            AS cl WHERE co.id_cliente = cl.id_cliente 
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox ">
                            ...
                            <div class="row focuss"><br>
                                ...
                                <div class="form-group col-md-5">
                                    <div class='row'>
                                        ...
                                        <div hidden id="b" class='col-md-8'>
                                        ...
                                        <div class='col-md-3'><br>
                                            <button type="button" id="change" style="margin-top:5%;" name="change" class="btn btn-sm btn-success pull-right usage"><i class="fa fa-exchange"></i> F3 Descripción</button>
                                        </div>
                                    </div>
                                </div>
                                <!-- APARTADO DE BOTONES DE FUNCIONES VARIAS -->
                                <div class="col-md-7"><br>
                                    <a class="btn btn-sm btn-danger pull-right" style="margin-left:1%;" href="dashboard.php" id='salir'><i class="fa fa-mail-reply"></i>
                                        F4 Salir</a>
                                    <button type="button" id="preventa" style="margin-left:1%;" name="preventa" class="btn btn-sm btn-success pull-right usage"><i class="fa fa-save"></i>
                                        F8 Guardar</button>
                                    <button type="button" id="borrar_preven" style="margin-left:1%;" name="borrar_preven" class="btn btn-sm btn-success pull-right usage"><i class="fa fa-trash"></i>
                                        F6 Borrar </button>
                            ...
                            <header>
                                <section>
                                    ...
                                    <div class="">
                                                            ...
                                                            <table>
                                                                <tbody>
                                                                    ...
                                                                    <tr class='cban'>
                                                                        ...
                                                                        <td class='cell100 column30'><input type="text" class="txt_box2 pago_banco" value=""></td>
                                                                    </tr>
                                                                    <tr class='cche'>
                                                                        <td class='cell100 column70 text-success'>NUMERO DE CHEQUE:</td>
                                                                        <td class='cell100 column30'><input type="text" class="txt_box2 pago_cheque" value=""></td>
                                                                    </tr>
                                                            ...
                                                            <table>
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class='cell100 column30'><input type="text" id="fecha_fact" class="txt_box2" value="<?php echo date(
                                                                            'd-m-Y'
                                                                        ); ?>"></td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        <td class='cell100 column70 text-success'>EFECTIVO:
                                                                            $</td>
                                                                        <td class='cell100 column30'> <input type="text" id="efectivov" class="txt_box2" value="">
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                        ...
                                        echo "<input type='hidden' name='cliente_nuevo' id='cliente_nuevo' value='0'>";
                                        echo "<input type='hidden' name='cant_abonar_cl_exis' id='cant_abonar_cl_exis' value='0'>";
                        ...
                        <!-- INICIO DE DECLARACION DE MODAL DE NUEVA NOTA DE CREDITO DE ABONO -->
                        <div class='modal fade' id='creditoAbono' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>
                            <div class='modal-dialog'>
                                <div class='modal-content modal-md' id="content_creditoAB" ></div><!-- /.modal-content -->
                            </div><!-- /.modal-dialog -->
                        </div><!-- /.modal -->
                        <!-- FIN DE DECLARACION DE MODAL NUEVA NOTA DE CREDITO DE ABONO -->
    ...
    if ($count_fact > 0) {
        ...
        for ($i = 0; $i < $count_fact_det; $i++) {
            ...
            $sql_res_pre = _fetch_array(
                _query(
                    "SELECT SUM(factura_detalle.cantidad) as reserva FROM factura JOIN factura_detalle ON factura_detalle.id_factura=factura.id_factura WHERE factura_detalle.id_prod_serv=$id_producto AND factura.id_sucursal=$id_sucursal AND factura.fecha = '$hoy' AND factura.finalizada=0 "
                )
            );
...
function insertar()
{
    ...
    if ($tipo_impresion == 'TIK') {
        ...
        $serie = $swl['serie_cof'];
        $sql_ult = _query("SELECT MAX(CONVERT(num_fact_impresa,UNSIGNED INTEGER)) 
                                as ultimo FROM factura 
                                WHERE id_sucursal=$id_sucursal AND tipo_documento='COF' ");
        ...
        $sql_ult = _query("SELECT MAX(CONVERT(num_fact_impresa,UNSIGNED INTEGER)) 
                                as ultimo FROM factura 
                                WHERE id_sucursal=$id_sucursal AND tipo_documento='CCF' ");
        $num_rows_ul = _num_rows($sql_ult);
        if ($num_rows_ul > 0) {
            # code...
            $ul = _fetch_array($sql_ult);
...
function insertar_preventa()
{
    ...
    /**
     * Variables que serviran para crear la
     * nota de abono (nuevo credito)
     */
    $credito = $_POST['credito'];
    ...
    /**
     * A CONTINUACION VAMOS A ACTUALIZAR (EN CASO DE QUE YA EXISTA)
     * LA FACTURA, O EN SU DEFECTO CREAR UNA NUEVA
     */
    if ($id_factura == '0') {
        # code...
        $table_fact = 'factura';
         ...
         * CLIENTE ESTA SOLICITANDO UN CREDITO CON
         * ABONO INICIAL
         */
        $credd = 1;
        if ($credito == 1) {
...
function guardar_nuevo_cliente($nombre_cliente, $telefono_cliente, $dui_cliente)
{
  ...
  $id_sucursal = $_SESSION["id_sucursal"];
  $sql_exis=_query("SELECT id_cliente FROM cliente WHERE nombre ='$nombre' AND id_sucursal='$id_sucursal' AND dui='$dui'");
